...
function showAuthDropdown() {
    ...
    dropdown.style.cssText = 'position:fixed;top:100px;right:110px;background:#fff;border:1.5px solid #e0d8cc;box-shadow:0 4px 16px rgba(0,0,0,0.12);z-index:9999;min-width:220px;overflow:hidden;';
